...
public class SignatureService {
    ...
    private void addDocumentReference(XMLSignature signature, Document document) throws Exception {
        ...
        // Agregar referencia con URI vacía para firmar todo el documento
